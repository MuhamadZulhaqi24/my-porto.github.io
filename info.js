let info = {
  ...
  description:
    "hey there, I'm Muhamad Zulhaqi about to graduate from the computer and information technology. A Webiste Development with 4+ experience familiar with HTML, TypeScript, Java, JavaScript also, a Frontend Engineer with 4+ experience, experience with Angular, Vuejs, Bootstraps and Node.",
  links: {
    linkedin: "https://www.linkedin.com/in/zulhaqi/",
    github: "https://github.com/MuhamadZulhaqi24",
    behance: "https://www.behance.net/",
    resume:
      "https://drive.google.com/file/d/1W0pzOo1Gb-W70BYKehOfZ4qaJt7m1_7O/view?usp=sharing",
  },
  education: [
    {
      name: "Senior High School 1 Indramayu",
      place: "Indramayu",
      date: "2016 - 2019",
      description: "",
      skills: ["Basketball", "Red Cross youth Volunteer"],
    },
    {
      name: "University Komputer Indonesia",
      place: "Bandung",
  ...
  experience: [
    {
      ...
      position: "as Student",
      description: "Learning About Cloud Computing Support by Google Cloud",
      skills: ["Cloud Computing", "phyton"],
    },
    {
      name: "Cisco Networking",
      date: "Oct 2021 - Sep 2022",
      position: "Intermediate Cyber Security",
      description: "CCNA: Switching, Routing, and Wireless, understanding of Security Operations. developed problem-solving skills to detect and analyze intrusions and monitor the network",
      skills: ["Packet Tracer", "Kali Linux"],
    },
    {
      name: "PT Ursa Byte",
      place: "Bandung",
      date: "Sep 2022 - Present",
      position: "Front-end Development, IT Support",
      description:
        "part of team and developers to create technically website mockup, using Visual Studio Code for best user solution ,finishing 80% of tasks before the target ",
      skills: ["TypeScript", "Angular", "Figma", "VueJs", "Go", "Echo"],
    },
  ],
  skills: [
    {
      title: "Language",
      info: ["TypeScript", "Java", "Javascript", "C#"],
      icon: "fa fa-code",
    },
    {
      title: "Front-end",
      info: ["HTML5", "CSS3", "SCSS", "Bootstrap5", "Pinia"],
      icon: "fa fa-cubes",
    },
    {
      title: "Web Technologies",
      info: ["Vue", "Angular", "React", "Node"],
